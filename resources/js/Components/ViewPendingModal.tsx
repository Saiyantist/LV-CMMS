        ...
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
            <div className="bg-white p-8 rounded-lg shadow-lg w-full sm:w-[500px] md:w-[600px] lg:w-[700px] relative">
                ...
                <div className="space-y-4 text-sm text-gray-700">
                    <div className="border p-4 rounded-md">
                        <div className="flex mb-2">
                            ...
                            <span className="ml-2">{request.dateSubmitted}</span>
                        </div>
                ...
                <div className="flex justify-end mt-6 space-x-4">
                    ...
                    <button
                        onClick={onDecline}
                        className="text-white bg-redbutton hover:bg-red-600 px-4 py-2 rounded-md text-sm"
                    >
                        Decline
                    </button>
                    <button
                        onClick={() => setShowWorkOrderForm(true)}
                        className="text-white bg-bluebutton hover:bg-green-600 px-4 py-2 rounded-md text-sm"
                    >
                        Accept
                    </button>
                </div>
                ...
                {showWorkOrderForm && (
                    <>
                        <hr className="my-6 border-gray-300" /> {/* Separator Line */}

                        <h2 className="text-lg font-semibold mb-4">Set up Work Order</h2>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="grid grid-cols-3 gap-4">
                                <div>
                                    <label className="block text-sm font-medium">Work Order Type</label>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select multiple className="w-full border p-2 rounded" size={2}>
                        ...
                        <div className="flex justify-end space-x-4 mt-4">
                            ...
                            <button
                                className="text-white bg-bluebutton hover:bg-blue-600 px-4 py-2 rounded-full text-sm"
                            >
                                Update
                            </button>
                        </div>
