      ...
      <DialogContent className="w-full sm:max-w-lg md:max-w-xl lg:max-w-3xl max-h-[95vh] p-0 overflow-visible">
            ...
            <div className="px-2 -mt-2 space-y-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="remarks">Remarks</Label>
                    ...
                    />
                    {localErrors.remarks && (
                        <p className="text-red-500 text-xs">{localErrors.remarks}</p>
                    )}
                </div>
                    ...
                    <div className="p-4 bg-muted rounded">
                        ...
                        >
                            <div className="text-center">
                                <p className={`text-sm mb-1 transition-colors duration-300 ${isDraggingOver ? "text-primary" : "text-primary"}`}>
                                    {isDraggingOver ? "Drop files here" : "Choose a file or drag & drop it here"}
                                </p>
                            <p className="text-xs text-secondary/70">JPEG, JPG, and PNG formats, up to 1MB</p>
                            </div>
                            <Button
                                variant="outline"
                                size="sm"
                        ...
                        {localErrors.images && <p className="text-red-500 text-xs">{localErrors.images}</p>}
        ...
        <DialogFooter className="px-6 py-4 border-t">
            ...
            <Button type="submit" onClick={submit}
                className="bg-primary hover:bg-primary/90 text-white">Create</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  )
