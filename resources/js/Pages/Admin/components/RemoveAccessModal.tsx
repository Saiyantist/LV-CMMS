...
export default function RemoveAccessModal({ user, onClose }: RemoveAccessModalProps) {
    const handleRemoveAccess = () => {
        router.patch(
            `/admin/manage-roles/${user.id}/remove-access`,
            {},
            {
                preserveScroll: true,
                onSuccess: () => {
                ...
                onError: (error) => alert(error.message || "Error removing access"),
            }
        );
    };
