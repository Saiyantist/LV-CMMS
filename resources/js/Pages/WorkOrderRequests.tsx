...
import ViewPendingModal from "@/Components/ViewPendingModal";
...
const WorkOrderRequests: React.FC = () => {
    ...
    const handleViewClick = (request: any) => {
        if (activeTab === "Pending") {
            ...
            console.log(
                "You can create a different modal or logic for non-pending requests."
            );
        }
    };
                ...
                <div className="flex-1 p-8 overflow-y-auto">
                    <div className="container p-2 mx-auto sm:p-4 dark:text-gray-800">
                        ...
                        <div className="mb-4 flex items-center space-x-4">
                            ...
                            <button
                                className="bg-secondary text-white px-4 py-2 rounded-md hover:bg-blue-800 transition-colors duration-200 text-sm"
                                onClick={() =>
