...
class WorkOrderFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'status' => fake()->randomElement(['Pending', 'Assigned', 'Ongoing', 'Overdue', 'Completed', 'Cancelled']),
            'work_order_type' => fake()->randomElement(['Work Order', 'Preventive Maintenance', 'Compliance']),
            'label' => fake()->randomElement(['Electrical', 'Plumbing', 'Painting', 'Carpentry', 'No Label']),
